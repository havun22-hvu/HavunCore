...
- [constraints-die-werk-blokkeren.md](patterns/constraints-die-werk-blokkeren.md) - Elke constraint blokkeert ergens gewoon werk; hoe je dat vindt, en waarom bestaande data de regel niet hoeft te halen
