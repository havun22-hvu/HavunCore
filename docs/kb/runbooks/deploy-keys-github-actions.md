...
| ~~Vusista~~ | — | — | **Vervallen 31-07-2026** — serveromgeving opgeruimd (desktop-app). De deploy-key `server-read` kan uit de repo-settings; de workflows deployen nergens meer naartoe. |
